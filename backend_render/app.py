...
# --- Inisialisasi Firebase Admin SDK (pakai service account, bukan billing GCP) ---
cred_json_env = os.environ.get("FIREBASE_CREDENTIALS_JSON")
cred_path_env = os.environ.get("FIREBASE_CREDENTIALS_PATH", "serviceAccountKey.json")
if cred_json_env:
    import json as _json_cred
    cred = credentials.Certificate(_json_cred.loads(cred_json_env))
else:
