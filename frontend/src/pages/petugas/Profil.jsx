...
import { LogOut, User, Printer } from "lucide-react";
        ...
        <div data-testid="profil-page">
            ...
            <div className="p-5 space-y-4">
                <Card className="p-5 border-slate-200 text-center">
                    ...
                    <div className="mt-3 font-semibold text-lg">{user?.nama}</div>
                ...
                <Card className="p-4 border-slate-200">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="font-semibold text-sm">Printer Bluetooth</span>
                    </div>
